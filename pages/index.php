...
<body>
    ...
    <div id="services" class="services">
        ...
        <!-- <div class="rect1">
            <p>WAREHOUSING</p>
            <P>up to 200 pallet places</P>
        </div>
        <div class="rect2">
            <p>Distribution</p>
            <P>Across the Europe</P>
        </div>
        <div class="rect3">
            <p>ROAD TRANSPORT</p>
            <P>With our own trucks</P>
        </div>
        <div class="rect4">
            <p>CONTAINER HANDLING</p>
            <P>Reliable transhipment</P>
        </div>
        <div class="paragraph">
            <p></p>
        </div>
                ...
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.005 512.005" style="enable-background:new 0 0 512.005 512.005;" xml:space="preserve">
                    <g>
                        <g>
                            ...
                            <rect x="277.188" y="58.999" transform="matrix(0.7071 -0.7071 0.7071 0.7071 44.6349 291.5472)" width="194.116" height="65.791" />
                        </g>
                    </g>
                    <g>
                        <g>
    ...
    c10.29-26.946,15.411-51.586,15.411-73.124C512.005,106.449,504.142,84.526,488.509,68.892z" />
                    ...
                    <g>
                        <g>
                            ...
                            <rect x="-5.393" y="341.447" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -237.6261 174.3659)" width="194.116" height="65.152" />
                        </g>
                    </g>
                    <g>
                    </g>
    ...
    <div class="contact">
        <div class="address-contact">
            <p class="address-paragraph">ADRESA</p>
            <p class="addresses">Joseph T. Villanvera 129 North street </p>
            <p class="addresses">Grand Rapids, MI 49546</p>
        </div>
        <div class="email-contact">
            <p class="email-paragraph">EMAIL</p>
            <p class="emails">incognito@gmail.com</p>
            <p class="emails">office@bcreative.com</p>
        </div>
        <div class="phone-contact">
            <p class="phone-paragraph">TELEFON</p>
            <p class="phones">+387 61 111 222</p>
            <p class="phones">+387 32 222 333</p>
        </div>
    </div>
    </div>
