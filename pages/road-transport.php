<head>
    ...
    <link rel="stylesheet" href="../css/road-transport.css">
...
<body>
    ...
    <div class="rt-hero">
        ...
        <div class="rt-illustration">
        <div class="rt-overlay"></div>

            <div class="rt-hero-section-text">
                <p class="rt-hero-text">Let us be your</p>
                <p class="solution">ULTIMATE </p>
                <p class="rt-hero-text">travel partner</p>
            </div>
        </div>
    </div>
