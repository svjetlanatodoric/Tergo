...
<body>
    ...
    <div class="distribution-hero">
        ...
        <div class="distribution-illustration">
            <div class="distribution-overlay"></div>
            <!-- <img src="../img/distribution-img.jpg" alt=""> -->

            <div class="hero-section-text">
                <p class="distribution-hero-text"> Reliable and affordable</p>
                <p class="solution">distribution</p>
                <p class="distribution-hero-text">of goods</p>
            </div>
        </div>
    </div>
